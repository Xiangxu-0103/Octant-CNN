...
parser.add_argument('--model', default='octant_cnn_cls', help='Model name. [default: octant_cnn_cls]')
parser.add_argument('--batch_size', type=int, default=16, help='Batch Size during training [default: 16]')
parser.add_argument('--num_point', type=int, default=1024, help='Point Number [256/512/1024/2048] [default: 1024]')
parser.add_argument('--model_path', default='log/best_model.ckpt',
                    help='model checkpoint file path [default: log/best_model.ckpt]')
